...
public class Location {
	...
	/**
	 * Computes the great circle distance between this Location instance
	 ...
	 * argument.
	 */
	public double distanceTo(Location location, double radius) {
	 ...
	 * by this Location instance that is less or equal to the distance
	 * argument.</p>
	 * <p>For more information about the formulae used in this method visit
	 * <a href="http://JanMatuschek.de/LatitudeLongitudeBoundingCoordinates">
	 * http://JanMatuschek.de/LatitudeLongitudeBoundingCoordinates</a>.</p>
	 * @param distance the distance from the point represented by this
	 * Location instance. Must me measured in the same unit as the radius
	 * argument.
	 * @param radius the radius of the sphere, e.g. the average radius for a
	 * spherical approximation of the figure of the Earth is approximately
	 * 6371.01 kilometers.
	 ...
	 * </ul>
	 */
	public Location[] boundingCoordinates(double distance, double radius) {
